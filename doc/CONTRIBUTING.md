...
First of all, thank you for contributing to BincNote Cloud! The goal of this document is to provide everything you need
to know in order to contribute to BincNote Cloud and its different integrations.
...
1. **You're familiar with [GitHub](https://github.com) and
   ...
   PR) workflow.**
2. **You know about the [BincNote community](https://discord.gg/9Q2xaN37tV). Please use this for help.**

## How to Contribute

Contributions are welcome! Here's how you can help improve BincNote Cloud:

1. Identify or propose enhancements or fixes by
   checking [existing issues](https://github.com/BincNote-IO/BincNote-Cloud/issues)
   or [creating a new one](https://github.com/BincNote-IO/BincNote-Cloud/issues/new/choose).
...
6. [Open a Pull Request (PR)](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request-from-a-fork)
   against the `main` branch of the original BincNote Cloud repo. Await feedback or approval from the maintainers.
