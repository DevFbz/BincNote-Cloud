...
fn document_plain_text() {
  ...
  let expected = "Welcome to BincNote$Download for macOS, Windows, and Linuxlink$$$quick startAsk AI powered by advanced AI models: chat, search, write, and much more ✨❤\u{fe0f}Love BincNote and open source? Follow our latest product updates:Twitter: @bincnoteReddit: r/bincnoteGithub";
